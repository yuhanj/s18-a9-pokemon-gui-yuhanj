...
public abstract class Pokemon implements Comparable <Pokemon> {
   ...
   *@throws PokemonException when the name would be empty. 
   **/
   public Pokemon(String species, String name, 
      ...
      //name = name.trim();
      if (name.length() == 0) {
         throw new PokemonException("The name cannot be empty.");
      } else {
         this.name = name;
      }
      this.number = number;
  ...
  * @throws PokemonException when the name is empty.
  */
   ...
   */  
   ...
   /**
   * compare a pokemon with another pokemon.
   * the return value is follow the sequence of comparasion
   * @param poke2 another pokemon
   * @return will return 0 if all the compared parts are the same
   */
   public int compareTo(Pokemon poke2) {
      if ((this.number - poke2.getNumber()) < 0) {
         return -1;
      }  else if ((this.number - poke2.getNumber()) > 0) {
         return 1;
      }  else if (this.name.compareTo(poke2.getName()) < 0) {
         return -2;
      }  else if (this.name.compareTo(poke2.getName()) > 0) {
         return 2;
      }  else if ((this.hP - poke2.hP) < 0) {
         return -3;
      }  else if ((this.hP - poke2.hP) > 0) {
         return 3;
      }  else if ((this.cP - poke2.cP) < 0) {
         return -4;
      }  else if ((this.cP - poke2.cP) > 0) {
         return 4;
      }  else if (this.fastAttack.compareTo(poke2.getFastAttack()) < 0) {
         return -5;
      }  else if (this.fastAttack.compareTo(poke2.getFastAttack()) > 0) {
         return 5;
      }  else if (this.specialAttack.compareTo(poke2.getSpecialAttack()) < 0) {
         return -6;
      }  else if (this.specialAttack.compareTo(poke2.getSpecialAttack()) > 0) {
         return 6;
      }  else {
   ...
   /**
   * compare 2 pokemons and determine if they are the same.
   * @param poke2 another pokemon
   * @return true if all compared parts are the same
   */
   public boolean equals(Pokemon poke2) {
      if (this.compareTo(poke2) == 0) {
         return true;
      }
      return false;
